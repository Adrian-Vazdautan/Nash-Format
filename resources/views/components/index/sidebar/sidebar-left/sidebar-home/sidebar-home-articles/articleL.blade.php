	...
	#START : Edit
		...
		#START : UNDO
			...
			<div class='APPEARANCE_undo_option_js APPEARANCE_DARK_undo_option_js tosrjs p l w100 bgw pa sh br12 mb25 none tosrID".$article['id'].$IDWWRA."'>-->
				<div class='APPEARANCE_undo_option_js APPEARANCE_DARK_undo_option_js tosrjs p l w100 bgw pa sh br12 mb25 none tosrID'>
		...
		#START : UNDO-DELETED
			...
			<div class='tosr_removed_js p l w100 bgw pa sh br12 mb25 none tosr_removed_ID'>
	...
	#START : Window news
		if(isset($filter__menu) && $filter__menu !== null){
			if($numarul == 2){
				if($page == 1){
					require "news.php";-->
					@include('components.index.sidebar.sidebar-left.sidebar-home.sidebar-home-articles.news')
				<!--}
			}
		}
	#END
	...
	<!--START : Article-->
		<div class='mobile_plaid_css p l articleID'>
			<!--START Hide post. Complain-->
				...
				<div class='mobile_hide_post_js mobile_hpID none'>
					...
					<div class='APPEARANCE_hidePostComplain_js APPEARANCE_DARK_hidePostComplain_js rWPUjs none ab bgw f14 br12 u rwpuID'>
			...
			<div class='APPEARANCE_article_js DARK_THEME_COLOR_1 p l w100 pa mobile_pa_css mb25 bgw sh br12 tosaID'>
				<div class='mobile_rwwid roW1 w100'>
								...
								<div class='u widgetcommentid'><!--";
									...
									#Check if image is NOT stored in BD
									    if($isp_Avatar == ""){
									    	...
									    	$Show_Avatar = "--><div class='image_avatar_css p l dg alc jcc br50 cw'>n</div><!--";
									    } 
					...
					<!--START : Button-->
						...
						<div class='APPEARANCE_articleLButton_js APPEARANCE_DARK_articleLButton_js p r h30 w30 dg alc jcc br50 c cw4srtm cw4srtmnr' onclick='rowWindowPopUpFunction(".$article['id'].$IDWWRA.")'>
							<div class='cW4SRTMjs'>
				...
				<!--START : Title-->
					...
					<a href='https://think.ceo/article.php?id=' target='_blank' class='show_article_in_extended_mode_js f24 mt20 c fw articleLink mobile_pa_title_css mobile_none' title=''>
						<!--".$article['title']."-->title
					</a>
				<!--END-->
				<!--START : Tags-->
				...
				<!--START : Thumbnail-->
					<div class='article_thumbail_js'>
						...
						<img loading='lazy' class='article_image_thumbnail_css' src='src/du/thumbnail/' title='Image'>
						<div class='article_image_thumbnail_TITLE_css p l w100'>
							<!--".$article['thumbnail_description']."-->thumbnail_description
						</div>
					</div>
				<!--END-->
				<!--START : Title-->
				...
				<div class='article_text_'>
					<!--START : Content-->
						<!--<div class='content_textarea_js p l w100 content_ID".$article['id'].$IDWWRA."'>-->
						<div class='content_textarea_js p l w100 content_ID'>
					...
					<!--START : Shadow for text-->
						...
						<div class='APPEARANCE_aaaw_js APPEARANCE_DARK_article_shadow_for_text_js asft_id_'></div>
					<!--END-->
					<!--START : Show less-->
						<!--<div class='showLessCss c p l w100 none watShowLessID".$article['id'].$IDWWRA."' onclick='recoverButtonShowAll(".$article['id'].$IDWWRA.")'>-->
						<div class='showLessCss c p l w100 none watShowLessID' onclick='recoverButtonShowAll(".$article['id'].$IDWWRA.")'>
							Показать меньше
						</div>
					<!--END-->
				</div>
				<!--<div class='wGTRjs w100 p l mt20 wgtrbtnID".$article['id'].$IDWWRA." mobile_none'>-->
				<div class='wGTRjs w100 p l mt20 wgtrbtnID'>
					<!--START : Button-->
						<button type='button' class='APPEARANCE_continue_reading_js APPEARANCE_DARK_wGTR_js wGTR p l f14 fw c shg' onclick='showAll(".$article['id'].$IDWWRA.",`".$code."`)'>
							<!--".$languagesArticle[$selectedLanguage]['ContinueReading']."-->Continue reading →
						</button>
					<!--END-->
				</div>
				<div class='p l w100 mt20 mobile_pa_controls_css'>
					<!--START : Button Comment-->
						...
						<!--<div class='APPEARANCE_comment_js APPEARANCE_DARK_cls_js tfccb1 u p l c br12 pa10' id='cwcp' onclick='showComments(".$article['id'].$IDWWRA.",`1`)' title='".$languagesArticle[$selectedLanguage]['Comments']."'>-->
						<div class='APPEARANCE_comment_js APPEARANCE_DARK_cls_js tfccb1 u p l c br12 pa10' id='cwcp' onclick='showComments(".$article['id'].$IDWWRA.",`1`)' title=''>
							<div class='APPEARANCE_comment_ICON_js APPEARANCE_DARK_comment_ICON_js cwcpi p l bgsz16 w16 h16'><!--icon--></div>
							<div class='h16 lh16 p l ml10 f14'><!--".$countOfcomments[0]."-->0</div>
							<!--<div class='ab w100 mlm10 decorID".$article['id'].$IDWWRA."'><--icon-></div>-->
							<div class='ab w100 mlm10 decorID'><!--icon--></div>
						</div>
					<!--END-->
					<!--START : Button Like-->
						<div class='APPEARANCE_like_js APPEARANCE_DARK_cls_js tfccb1 u cwcpi3js p l c ml15 pa10 br12' onclick='setLS(".$article['id'].$IDWWRA.")'>
							...
							<div class='p l w16 h16 hlikeStatusjsID'>
								<!--".$likeStatus."-->
							</div>
							<!--<div class='h16 lh16 p l ml10 f14 counthlikeStatusjsID".$article['id'].$IDWWRA."'>".$cal[0]."</div>-->
							<div class='h16 lh16 p l ml10 f14 counthlikeStatusjsID'></div>
						</div>
					<!--END-->
					<!--START : Button Share-->
				...
				<!--START : Leave a comment on article-->
					...
					<div class='ccw p l mt20 pat none w100 LeaveAcommentID'>
						<!--START-->
							<div class='p l w100 f18 mb20'>
								<!--START : COUNT-->
									<!--<div class='p l countofcommentsID".$article['id'].$IDWWRA."'>".$countOfcomments[0]."</div>-->
									<div class='p l countofcommentsID'>0</div>
								<!--END-->
								<!--START : Title-->
									<div class='p l ml10'>
										<!--".$languagesArticle[$selectedLanguage]['Comments']."-->Comments
									</div>
								<!--END-->
							</div>
						<!--END-->
						<!--START : Wrapp ajax.response commentaryes article-->
							...
							<div class='pfacjs innerCommentsAndReplyesID'></div>
						<!--END-->
						<!--";
						if($countOfcomments[0] > 5){
							...
							<!--START : Button (View more comments)-->
								...
								<div class='w100 p l f14 pab countOfCommentsvcID' onclick='vcmcsdfc(".$article['id'].")'>
									<div class='smrc p l pal10 par10 smrccom'>
										...
										Показать <span class='vcmcsdfcspancountID'>0</span> больше комментарии →
									</div>
								</div>
							<!--END-->
							<!--";
							...
							<div class='APPEARANCE_articleLTextareaLeaveComment_js APPEARANCE_DARK_articleLTextareaLeaveComment_js p l cmc1js w100 pa10 br12'>
								<!--START-->
									<div class='w100 f18 mb20'>
										<!--".$languagesArticle[$selectedLanguage]['LeaveAcomment']."-->Leave a comment
									</div>
								<!--END-->
								<!--START-->
									<div class='txtlcmt p l w100'>
										<!--START : Textarea-->
			                                ...
			                                <input type='text' name='leaveAcommentary' class='c_lacfajs wwctit2Input w100 br50 sh pal commentID' placeholder='' onclick='removeErrorInput(".$article['id'].$IDWWRA.")'>
										<!--END-->
			                            <!--START : Button-->
